...
content VARCHAR(10000), user_id INTEGER, likes int NOT NULL DEFAULT 0, dislikes int  NOT NULL DEFAULT 0, date datetime DEFAULT current_timestamp, FOREIGN KEY(user_id) 
REFERENCES users(id));
